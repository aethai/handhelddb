    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#4a4560] mt-0.5">
        ...
        {stats && (
          <div className="flex flex-wrap gap-2">
            {stats.excellent > 0 && (
              <span className="inline-flex items-center gap-1 rounded-full bg-[#a78bfa]/10 border border-[#a78bfa]/20 px-2.5 py-1 text-xs text-[#a78bfa]">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1">
          <svg
            className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#4a4560]"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
          ...
          <input
            ...
            className="w-full rounded-lg border border-[#1a1828] bg-[#12101a] pl-10 pr-4 py-2 text-sm text-white placeholder-[#4a4560] focus:border-[#a78bfa] focus:outline-none focus:ring-1 focus:ring-[#a78bfa]"
          />
        </div>
        ...
        <select
          ...
          className="rounded-lg border border-[#1a1828] bg-[#12101a] px-3 py-2 text-sm text-gray-300 focus:border-[#a78bfa] focus:outline-none focus:ring-1 focus:ring-[#a78bfa] cursor-pointer"
        >
      ...
      {/* Legend */}
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-[#4a4560]">
      ...
      {filteredAndSorted.length > 0 ? (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 flex items-center gap-2 text-xs text-[#9890a8]">
                      {entry.preset && (
                ...
                <div className="mt-2 h-1 bg-[#12101a] rounded-full overflow-hidden">
                  <div
        ...
        <div className="rounded-xl border border-dashed border-[#1a1828] bg-[#0e0c16]/50 p-8 text-center">
          ...
          <p className="text-[#9890a8] text-sm">No games match "{search}"</p>
          <button
            onClick={() => setSearch('')}
      ...
      {search.trim() && filteredAndSorted.length > 0 && (
        <p className="text-xs text-[#4a4560] text-center">
