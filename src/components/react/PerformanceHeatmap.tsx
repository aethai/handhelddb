    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#55555e] mt-0.5">
        ...
        {stats && (
          <div className="flex flex-wrap gap-2">
            {stats.excellent > 0 && (
              <span className="inline-flex items-center gap-1 rounded-full bg-[#7c6cf0]/10 border border-[#7c6cf0]/20 px-2.5 py-1 text-xs text-[#7c6cf0]">
                <span className="h-1.5 w-1.5 rounded-full bg-[#7c6cf0]" />
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1">
          <svg
            className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#55555e]"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
          ...
          <input
            ...
            className="w-full rounded-lg border border-[#25252e] bg-[#1a1a22] pl-10 pr-4 py-2 text-sm text-white placeholder-[#55555e] focus:border-[#7c6cf0] focus:outline-none focus:ring-1 focus:ring-[#7c6cf0]"
          />
        </div>
        ...
        <select
          ...
          className="rounded-lg border border-[#25252e] bg-[#1a1a22] px-3 py-2 text-sm text-gray-300 focus:border-[#7c6cf0] focus:outline-none focus:ring-1 focus:ring-[#7c6cf0] cursor-pointer"
        >
      ...
      {/* Legend */}
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-[#55555e]">
        <span className="flex items-center gap-1.5">
          <span className="h-2.5 w-2.5 rounded-sm bg-[#7c6cf0]" />
          60+ FPS
        </span>
        <span className="flex items-center gap-1.5">
      ...
      {filteredAndSorted.length > 0 ? (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-medium text-white truncate group-hover:text-[#9b8fff] transition-colors">
                      {entry.gameName}
                    </p>
                    <div className="mt-1 flex items-center gap-2 text-xs text-[#8a8a94]">
                      {entry.preset && (
                ...
                <div className="mt-2 h-1 bg-[#1a1a22] rounded-full overflow-hidden">
                  <div
        ...
        <div className="rounded-xl border border-dashed border-[#25252e] bg-[#0f0f12]/50 p-8 text-center">
          ...
          <p className="text-[#8a8a94] text-sm">No games match "{search}"</p>
          <button
            onClick={() => setSearch('')}
            className="mt-2 text-xs text-[#7c6cf0] hover:text-[#9b8fff] transition-colors"
          >
            Clear search
          </button>
        </div>
      ...
      {search.trim() && filteredAndSorted.length > 0 && (
        <p className="text-xs text-[#55555e] text-center">
