              ...
              {categoryBadges.map((badge) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Tooltip on hover */}
                    {isHovered && (
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-10 w-48 rounded-lg border border-gray-700 bg-gray-800 p-3 shadow-xl pointer-events-none">
